...
font = {
        'weight' : 'bold',
        'size'   : 15}
my_dpi = 96 					#Change this with your monitor DPI
...
cutoffpl_Ep = np.array(cutoffpl_ifl['col7'])
...
bkn2powC_E1 = np.array(bkn2powC_parameters['col7'])
...
bkn2powC_E2 = np.array(bkn2powC_parameters['col13'])
...
fig = plt.figure(figsize=(1500/my_dpi, 1000/my_dpi), dpi=my_dpi)
...
#BB+BandC
plt.errorbar(time_main_plot[0:7],bb_bandC_Ep[0:11], yerr=[-1*bb_bandC_Ep_n[0:11], bb_bandC_Ep_p[0:11]], fmt = 'v', ls = lstyle, capsize=0, markerfacecolor='b',color='b', ms=7, label='BB+BandC (Ep)', markeredgewidth=0.5, markeredgecolor='b')
plt.errorbar(time_main_plot[0:7],Ktoffset*bb_bandC_kT[0:11], yerr=[-Ktoffset*bb_bandC_kT_n[0:11], Ktoffset*bb_bandC_kT_p[0:11]], fmt = 'v', ls = lstyle, capsize=0, markerfacecolor='None',color='b', ms=7, label='BB+BandC (kT)', markeredgewidth=0.5, markeredgecolor='b')
#BB + CLP + CPL
plt.errorbar(time_main_plot[0:13],comp3_E1[0:13], yerr=[-1*comp3_E1_n[0:13], comp3_E1_p[0:13]], fmt = '^', ls = lstyle, capsize=0, markerfacecolor='none',color='g', ms=7, label='BB + CLP + CPL (Ep1)', markeredgewidth=0.5, markeredgecolor='b')
plt.errorbar(time_main_plot[0:13],Ktoffset*comp3_kT[0:13], yerr=[-Ktoffset*comp3_kT_n[0:13], Ktoffset*comp3_kT_p[0:13]], fmt = '^', ls = lstyle, capsize=0, markerfacecolor='none',color='g', ms=7, label='BB + CLP + CPL (kT)', markeredgewidth=0.5, markeredgecolor='green')
#bkn2pow
plt.errorbar(time_main_plot[0:13], E1offset*bkn2powC_E1[0:13], yerr=[-E1offset*bkn2powC_E1_n[0:13], E1offset*bkn2powC_E1_p[0:13]], fmt = '<', ls = lstyle, capsize=0, markerfacecolor='r',color='r', ms=7, label='Bkn2powC (Ep1)', markeredgewidth=0.5, markeredgecolor='b')
plt.errorbar(time_main_plot[0:13],bkn2powC_E2[0:13], yerr=[-1*bkn2powC_E2_n[0:13], bkn2powC_E2_p[0:13]], fmt = '<', ls = lstyle, capsize=0, markerfacecolor='r',color='r', ms=7, label='Bkn2powC (Ep2)', markeredgewidth=0.5, markeredgecolor='b')
#Band
plt.errorbar(time_main_plot,band_Ep, yerr=[-1*band_Ep_n, band_Ep_p], fmt = '>', ls = lstyle, capsize=0, markerfacecolor='b',color='b', ms=7, label='Band (Ep)', markeredgewidth=0.5, markeredgecolor='b')
#BandC
plt.errorbar(time_main_plot[0:11],bandC_Ep[0:11], yerr=[-1*bandC_Ep_n[0:11], bandC_Ep_p[0:11]], fmt = '*', ls = lstyle, capsize=0, markerfacecolor='None',color='purple', ms=7, label='BandC (Ep)', markeredgewidth=0.5, markeredgecolor='b')
#BB+Band
plt.errorbar(time_main_plot[0:16][mask],bb_band_Ep[mask], yerr=[-1*bb_band_Ep_n[mask], bb_band_Ep_p[mask]], fmt = 'o', ls = lstyle, capsize=0, markerfacecolor='y',color='y', ms=7, label='BB+Band (Ep)', markeredgewidth=0.5, markeredgecolor='b')
plt.errorbar(time_main_plot[0:16][mask],Ktoffset*bb_band_kT[mask], yerr=[-Ktoffset*bb_band_kT_n[mask], Ktoffset*bb_band_kT_p[mask]], fmt = 'o', ls = lstyle, capsize=0, markerfacecolor='none',color='y', ms=7, label='BB+Band (kT)', markeredgewidth=0.5, markeredgecolor='b')
#Cutoff PL
plt.errorbar(time_pre_plot,Epoffset*cutoffpl_Ep, yerr=[-Epoffset*cutoffpl_Ep_n, Epoffset*cutoffpl_Ep_p], fmt = 'ro', ls = lstyle, capsize=0, markerfacecolor='Red',color='Cyan', ms=7, label='Cpl (Ep)', markeredgewidth=0.5, markeredgecolor='green')
#Preplot
plt.errorbar(time_pre_plot,Ktoffset*bbpl_pre_kT, yerr=[-Ktoffset*bbpl_pre_kT_n, Ktoffset*bbpl_pre_kT_p], fmt = 'go', ls = lstyle, capsize=0, markerfacecolor='Blue',color='magenta', ms=7, label='BBPL (kT)', markeredgewidth=0.5, markeredgecolor='b')
...
ax0.xaxis.set_major_locator(MaxNLocator(11))
#plt.tight_layout()
ax0.set_ylabel("Parameters in keV",fontsize= 15, labelpad = 10)
plt.xlabel(r'Time since GBM trigger$\/$(s)',fontsize=15)
plt.tick_params(labeltop=False, labelright=True)
plt.savefig("Ep_and_kT_evolution.pdf")
plt.show()
...
fig = plt.figure(figsize=(1500/my_dpi, 1000/my_dpi), dpi=my_dpi)
gs1 = gridspec.GridSpec(3, 1, height_ratios=[2, 1, 2])

ax1 = plt.subplot(gs1[0])
#ax1 = fig.add_axes(ylabel="E$_c$",xticklabels=[],ylim=(5,1.4e3),yscale='log')
...
#ax2 = fig.add_axes(ylabel="E$_c$2  / E$_c$1",xticklabels=[],ylim=(0,13),yscale='log')
plt.errorbar(time_main_plot, rat, yerr=sigma_y, fmt = '*', ls = lstyle, capsize=0, markerfacecolor='firebrick',color='firebrick', ms=7, label='Ratio', markeredgewidth=0.5, markeredgecolor='b')
ax2.set_ylim([0,13])
...
#ax3 = fig.add_axes(ylabel="Slopes",xticklabels=[],ylim=(-2,7),yscale='log')
...
#plt.tight_layout()
plt.xlabel(r'Time since GBM trigger$\/$(s)',fontsize=15, labelpad = 0)
plt.subplots_adjust(hspace=0.00)
plt.savefig("bkn2pow_pars.pdf")
plt.show()
